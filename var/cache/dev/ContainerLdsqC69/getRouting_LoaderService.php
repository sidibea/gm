...
$a = ($this->privates['file_locator'] ?? $this->privates['file_locator'] = new \Symfony\Component\HttpKernel\Config\FileLocator(($this->services['kernel'] ?? $this->get('kernel', 1)), ($this->targetDirs[3].'/app/Resources'), array(0 => ($this->targetDirs[3].'/app'))));
...
$e = new \SitemapPlugin\Routing\SitemapLoader(($this->privates['sylius.sitemap_builder'] ?? $this->load('getSylius_SitemapBuilderService.php')));
$e->setContainer($this);
...
$g->addLoader(new \Sylius\Bundle\ResourceBundle\Routing\ResourceLoader(($this->privates['sylius.resource_registry'] ?? $this->getSylius_ResourceRegistryService()), new \Sylius\Bundle\ResourceBundle\Routing\RouteFactory()));
$g->addLoader(new \FOS\RestBundle\Routing\Loader\DirectoryRouteLoader($a, $d));
$g->addLoader(new \FOS\RestBundle\Routing\Loader\RestRouteLoader($this, $a, $c, new \FOS\RestBundle\Routing\Loader\Reader\RestControllerReader(new \FOS\RestBundle\Routing\Loader\Reader\RestActionReader($b, new \FOS\RestBundle\Request\ParamReader($b), new \FOS\RestBundle\Inflector\DoctrineInflector(), true, array('json' => false, 'xml' => false, 'html' => true), true), $b), NULL));
$g->addLoader(new \FOS\RestBundle\Routing\Loader\RestYamlCollectionLoader($a, $d, true, array('json' => false, 'xml' => false, 'html' => true), NULL));
$g->addLoader(new \FOS\RestBundle\Routing\Loader\RestXmlCollectionLoader($a, $d, true, array('json' => false, 'xml' => false, 'html' => true), NULL));
$g->addLoader($e);
$g->addLoader($f);
