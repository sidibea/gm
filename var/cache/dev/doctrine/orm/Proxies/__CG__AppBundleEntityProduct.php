...
class Product extends \AppBundle\Entity\Product implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'variantSelectionMethod', 'productTaxons', 'channels', 'mainTaxon', 'reviews', 'averageRating', 'images', 'id', 'code', 'attributes', 'variants', 'options', 'associations', 'createdAt', 'updatedAt', 'enabled', 'translations', 'translationsCache', 'currentLocale', 'currentTranslation', 'fallbackLocale', 'brand'];
        }
     ...
     * {@inheritDoc}
     */
    public function getBrand(): ?\Loevgaard\SyliusBrandPlugin\Entity\BrandInterface
    {
     ...
     * {@inheritDoc}
     */
    public function setBrand(\Loevgaard\SyliusBrandPlugin\Entity\BrandInterface $brand): void
    {
