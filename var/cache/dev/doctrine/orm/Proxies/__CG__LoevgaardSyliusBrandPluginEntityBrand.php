...
namespace Proxies\__CG__\Loevgaard\SyliusBrandPlugin\Entity;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class Brand extends \Loevgaard\SyliusBrandPlugin\Entity\Brand implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'slug', 'name', 'images'];
        }
